...
public class LilianWokeManager : SkillObjectManager
{
    ...
    void Buff()
    {
        ...
        statusManager.ChangeStatusMultiplier(StatusType.Attack, _info.AncestralDamageBuffPercent, true);
    ...
    void Debuff()
    {
        ...
        statusManager.ChangeStatusMultiplier(StatusType.Attack, _info.AncestralDamageBuffPercent, false);

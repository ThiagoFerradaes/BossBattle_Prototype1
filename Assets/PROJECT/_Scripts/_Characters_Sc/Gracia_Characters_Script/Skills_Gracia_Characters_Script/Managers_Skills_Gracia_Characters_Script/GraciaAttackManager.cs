...
public class GraciaAttackManager : SkillObjectManager {
    ...
    protected override void FourthFunc() {
        ...
        float realCooldown = cooldown / _attackSpeedMultiplier; // Se a velocidade de ataque for maior ent�o o cooldown diminui
        ...
        else _attackIndex = 1; // Se chegou no 3 ent�o volta pro 1

        // VOLTANDO OS INPUTS
        UnblockInputs();

        // COME�ANDO O TEMPORIZADOR ENTRE ATAQUES
